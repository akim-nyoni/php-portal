      ...
      if ($count == 1) {
        while ($rows = mysqli_fetch_array($ses_sql, MYSQLI_ASSOC)) {
          if ($rows['Account'] == $acc_num) {
            ...
            ?>
            <script>window.location="https://balance.beitbridgemun.co.zw/dashboard.php";</script>
            <?php
          } else {
            ...
            <div class="form-wrapper">
              ...
              <div class="form-container">
                ...
                <form action="" method="post" autocomplete="off">
                  ...
                  <p class="text mt-3">Don't have an account? <a href="/register.php" class="link-primary text-decoration-none">Register</a></p>
                </form>
              </div>
            </div>
          </div>
